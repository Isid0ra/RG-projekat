...
// load textures
    ...
    unsigned int transparentTexture = loadTexture(FileSystem::getPath("resources/textures/bstar.png").c_str(), true);
...
void DrawImGui(ProgramState *programState) {
...

    {
        ...
        ImGui::Text("Little Prince");
        ImGui::SliderFloat("Float slider", &f, 0.0, 1.0);
        ImGui::ColorEdit3("Background color", (float *) &programState->clearColor);
        ImGui::DragFloat3("Rose position", (float*)&programState->rosePosition);
        ImGui::DragFloat("Rose scale", &programState->roseScale, 0.05, 0.1, 4.0);
